...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hey") || message.includes("hello , Sohail") || message.includes("hey , Sohail")) {
        wishMe();
        speak("I'm Sohail ahmed your Virtual Assistant here What can I help you?");
    } 
        ...
        speak("I am a virtual assistant, created by Mr. Sohail Ahmed.");
    } 
        ...
        let finalText = "This is what I found on the internet regarding " + message.replace("sohail", "");
        speak(finalText);
        window.open(`https://www.google.com/search?q=${message.replace("sohail", "")}`, "_blank");
    }
}